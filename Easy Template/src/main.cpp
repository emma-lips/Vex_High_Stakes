...
void initialize() {
  ...
  chassis.opcontrol_curve_default_set(3.2, 3.2);     // Defaults for curve. If using tank, only the first parameter is used. (Comment this line out if you have an SD card!)
