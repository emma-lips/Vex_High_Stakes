...
class ControllerSettings
{
 public:
   ...
   * @endcode
   */
  ControllerSettings(float kP, float kI, float kD, float windupRange, float smallError, float smallErrorTimeout, float largeError,
...
class Drivetrain
{
 public:
   ...
   * @endcode
   */
  Drivetrain(pros::MotorGroup* leftMotors, pros::MotorGroup* rightMotors, float trackWidth, float wheelDiameter, float rpm,
...
class Chassis
{
 public:
   ...
   * @example main.cpp
   */
  Chassis(Drivetrain drivetrain, ControllerSettings linearSettings, ControllerSettings angularSettings, OdomSensors sensors,
