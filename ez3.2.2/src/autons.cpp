...
void worldssixdonutsrightred() {
  ...
  chassis.pid_drive_set(-18.5, FULL_SPEED);//CHANGE IF SWING NO HIT
  chassis.pid_wait_quick_chain();
  // chassis.pid_drive_set(-1.5, slow_speed);
  // chassis.pid_wait_quick_chain();
  ...
  chassis.pid_swing_set(ez::RIGHT_SWING, 90_deg, 127, 45);
  chassis.pid_wait_quick_chain();

  chassis.pid_turn_set(74.29, FULL_SPEED);
  chassis.pid_wait_quick_chain();

  chassis.pid_drive_set(49.86, FULL_SPEED);
  chassis.pid_wait_quick_chain();
